...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2025 at 01:41 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `filestobedistroid` (IN `compareDate` DATE)   BEGIN
    SELECT *
    FROM files
    WHERE timestampdiff(year, fileClosedOn, compareDate) > 12
      AND fileDistroiedOn = '0000-00-00';
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `filestobedistroidtonow` ()   BEGIN
...
INSERT INTO `files` (`fileNumber`, `fileName`, `fileClosedOn`, `ReceivedRROn`, `getBackOfficeOn`, `departmentName`, `officerName`, `ReceivedBackToRROn`, `cellNo`, `rackNo`, `numPages`, `fileDistroiedOn`, `Note`, `fileTypeId`) VALUES
('BA001/2018', 'P K ABERATHNA', '2018-12-31', '2023-05-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '225', '0000-00-00', '', 3),
('BA002/2015', 'M F M RISHAM', '2015-07-30', '2020-09-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '100', '0000-00-00', '', 3),
('BA002/2018', 'MAHINDASIRI RANAWEERA', '2018-06-08', '2023-05-30', '2025-01-10', 'Engineering', 'K. Jayalath', '0000-00-00', 25, 2, '150', '0000-00-00', '', 3),
('BA003/2015', 'T T BOGODAGE', '2016-05-30', '2021-09-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '263', '0000-00-00', '', 3),
('BA004/2015', 'M P O DE SILVA', '2015-09-27', '2020-09-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '178', '0000-00-00', 'ගොණුව පිළිබද සටහන', 3),
('BA005/2015', 'W D THAMINDA SAMAN KUMARA', '2015-08-20', '2020-09-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '1-20, 22-265', '0000-00-00', '', 3),
('BA005/2018', 'PRATHAPA SAYAKKARAGE DINESH CHAMARA', '2018-04-19', '2023-05-30', '0000-00-00', '', '', '0000-00-00', 25, 2, '353', '0000-00-00', '', 3),
('BA006/2015', 'L R KUMARA ABENAYAKA', '2015-08-01', '2020-09-30', '0000-00-00', '', '', '0000-00-00', 26, 2, '145', '0000-00-00', '', 3),
('BA006/2018', 'A G LESLI', '2018-08-30', '2023-09-30', '0000-00-00', '', '', '0000-00-00', 26, 2, '125', '0000-00-00', '', 3),
...
('BA021/2011', 'YASANTHA GAMAGE', '2011-06-16', '2021-09-30', '0000-00-00', '', '', '0000-00-00', 26, 2, '', '0000-00-00', '', 3),
('BA035/2012', 'I H GAYAN VINEETHA', '2012-11-22', '2023-11-30', '0000-00-00', '', '', '0000-00-00', 30, 2, '', '0000-00-00', '', 3),
...
('P152', 'Gamage Mangalika', '0000-00-00', '2025-05-04', '0000-00-00', '', '', '0000-00-00', 11, 1, '', '0000-00-00', '', 5),
...
('P322', 'Sarath Kumara Gamage', '0000-00-00', '2025-05-04', '0000-00-00', '', '', '0000-00-00', 10, 1, '', '0000-00-00', '', 5),
...
('SD045/2011', 'K.A. Udayakumara', '2011-08-14', '2011-12-10', '0000-00-00', '', '', '0000-00-00', 30, 2, '1-256, 258-260', '0000-00-00', '', 2),
...
('Voucher of 2015-05', 'Voucher of 2015-05', '2015-06-30', '2024-01-10', '0000-00-00', '', '', '0000-00-00', 20, 1, '1-200', '0000-00-00', '', 4);
...
(2, 'Asanga', 'Admin', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'),
(3, 'Thulankana', 'Editor', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'),
(4, 'Janaka', 'Viewer', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'),
(6, 'Admin', 'Admin', '4fc82b26aecb47d2868c4efbe3581732a3e7cbcc6c2efb32062c08170a05eeb8');
